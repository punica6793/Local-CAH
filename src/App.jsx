...
export default function App() {
  ...
  // Dense, Opaque Background Design Element
  const BackgroundDesign = () => {
    const letterColor = isDark ? "rgba(255, 255, 255, 0.15)" : "rgba(0, 0, 0, 0.15)";
    return (
      <div style={{ position: "absolute", width: "100%", height: "100%", top: 0, left: 0, overflow: "hidden", pointerEvents: "none", zIndex: 0 }}>
        <div style={{ position: "absolute", fontSize: "150px", fontWeight: "900", color: letterColor, top: "-20px", left: "10%", transform: "rotate(-15deg)" }}>F</div>
        <div style={{ position: "absolute", fontSize: "120px", fontWeight: "900", color: letterColor, top: "20px", right: "20%", transform: "rotate(18deg)" }}>a</div>
        <div style={{ position: "absolute", fontSize: "180px", fontWeight: "900", color: letterColor, bottom: "-40px", left: "20%", transform: "rotate(35deg)" }}>m</div>
        <div style={{ position: "absolute", fontSize: "140px", fontWeight: "900", color: letterColor, top: "40%", right: "5%", transform: "rotate(-25deg)" }}>i</div>
        <div style={{ position: "absolute", fontSize: "160px", fontWeight: "900", color: letterColor, bottom: "10px", right: "15%", transform: "rotate(12deg)" }}>l</div>
        <div style={{ position: "absolute", fontSize: "200px", fontWeight: "900", color: letterColor, top: "10%", left: "40%", transform: "rotate(-8deg)" }}>y</div>
      </div>
    );
  };

  const FamilyEditionLabel = ({ cardTheme }) => {
    // Dynamic color for the stamp
  ...
  if (!isJoined) {
    return (
      <div style={basePageStyle}>
        <BackgroundDesign />
        <button onClick={() => setTheme(isDark ? "light" : "dark")} style={{ position: "absolute", top: "24px", right: "24px", padding: "8px 16px", border: `3px solid ${fgMain}`, backgroundColor: bgMain, color: fgMain, fontWeight: "900", fontSize: "12px", cursor: "pointer", zIndex: 10 }}>
          {isDark ? "☀️ LIGHT" : "🌙 DARK"}
        </button>
